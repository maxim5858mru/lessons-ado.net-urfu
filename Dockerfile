...
# docker run -it --expose 1-65535 -p 1433:1433 -p 13500:135 --hostname Microsoft-SQL-Server --name microsoft-sql-server-developer maxim5858mru/lessons-database:microsoft-sql-server-developer